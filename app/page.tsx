...
const TOOLS: Tool[] = [
  ...
  { id: 'windhawk', label: 'Windhawk', href: 'https://windhawk.net/', description: 'Customize Windows apps and system behavior with lightweight runtime patches', icon: '✨', tags: ['open-source', 'customization', 'runtime-patching', 'windows', 'tweaks'], category: 'Desktop Customization', section: 'UI Tweaks', platform: 'Windows' },
  ...
  // Privacy
  { id: 'hostfile', label: 'hosts file', href: 'https://winhelp2002.mvps.org/hosts.htm', description: 'Block ads & malware via hosts file', icon: '🚫', tags: ['guide', 'ad-blocking', 'malware-blocking', 'network-security'], category: 'Network Security', section: 'Privacy', platform: 'Windows' },
